          ...
          <section class="table-section">
            <div class="table glass" id="table1">
              <table>
                ...
                <xsl:variable
                  name="transactions"
                  select="transactions/transaction[kwota/@waluta='PLN' and (nazwa_transakcji='wpłata' or nazwa_transakcji='odsetki' or nazwa_transakcji='przelew' or nazwa_transakcji='korekta')]"
                />
                <xsl:variable
                  name="wpłataSum"
                  select="sum($transactions[nazwa_transakcji='wpłata']/kwota)"
                />
                <xsl:variable
                  name="odsetkiSum"
                  select="sum($transactions[nazwa_transakcji='odsetki']/kwota)"
                />
                <xsl:variable
                  name="przelewSum"
                  select="sum($transactions[nazwa_transakcji='przelew']/kwota)"
                />
                <xsl:variable
                  name="korektaSum"
                  select="sum($transactions[nazwa_transakcji='korekta']/kwota)"
                />
                <tr>
                  <td>1</td>
                  <td>wpłata</td>
            ...
            <div class="table glass" id="table2">
              <table>
                ...
                <xsl:variable
                  name="transactions"
                  select="transactions/transaction[kwota/@waluta='EUR' and (nazwa_transakcji='wpłata' or nazwa_transakcji='odsetki' or nazwa_transakcji='przelew' or nazwa_transakcji='korekta')]"
                />
                <xsl:variable
                  name="wpłataSum"
                  select="sum($transactions[nazwa_transakcji='wpłata']/kwota)"
            ...
            <div class="table glass" id="table3">
              <table>
                ...
                <xsl:variable
                  name="janCount"
                  select="count(transactions/transaction[wykonal='Jan J.'])"
                />
                <xsl:variable
                  name="ewaCount"
                  select="count(transactions/transaction[wykonal='Ewa B.'])"
                />
                <xsl:variable
                  name="adamCount"
                  select="count(transactions/transaction[wykonal='Adam A.'])"
                />
                <tr>
                  <td>Jan J.</td>
